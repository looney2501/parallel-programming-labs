...
public class UtilsLab5 {
    ...
    public static void writeResultToFile(MyList list, int noThreads, int noProducers) {
        Node current = list.start.next;
        String path = "D:\\Proiecte\\Java\\PPD\\lab5\\resources\\output\\result-th-" + noThreads + "-pr-" + noProducers + ".out";
    ...
    public static void main(String[] args) {
        ...
        int polynomialDegreeBound = 10000;
